...
export async function saveInvestigation(user, investigation) {
  ...
  // ── Step 3: top-level doc — serverTimestamp() ONLY here, nowhere inside ──
  const docData = {
    ...
    createdAt: serverTimestamp(), // sentinel allowed at top level only ✓
    updatedAt: serverTimestamp(), // sentinel allowed at top level only ✓
  };
